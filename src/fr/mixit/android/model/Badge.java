...
/**
 * A badge rewarding some kind of awesome activity on LinkIT. Every badge MUST be displayable with an icon, either with an image file URL {@link Badge#iconUrl}
 * OR with an Unicode character {@link Badge#iconChar}.
 */
public enum Badge {
	 ...
	 */
	Badge() {
		iconUrl = BASE_URL + name().toLowerCase(Locale.getDefault()) + DEFAULT_IMAGE_EXT;
	}
