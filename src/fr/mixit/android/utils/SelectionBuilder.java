/* Copyright (C) 2011 The Android Open Source Project Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in
...
/* Modifications: -Imported from AOSP frameworks/base/core/java/com/android/internal/content -Changed package name */
...
/**
 * Helper for building selection clauses for {@link SQLiteDatabase}. Each appended clause is combined using {@code AND}. This class is <em>not</em> thread safe.
 */
public class SelectionBuilder {
	...
	public Cursor query(SQLiteDatabase db, String[] columns, String groupBy, String having, String orderBy, String limit) {
		...
		return db.query(mDistinct, mTable, columns, getSelection(), getSelectionArgs(), groupBy, having, orderBy, limit);
	}
